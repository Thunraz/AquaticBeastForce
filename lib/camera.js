function Camera(game, x, y, scale) {
    this.game = game;
...
Camera.prototype.render = function(background, entities) {
    ...
    this.ctx.translate(this.game.canvas.width / 2, this.game.canvas.height / 2);
    ...
    if(this.game.player.health <= 0) {
        ...
        this.drawNum(this.game.player.shots.toString(), 10, 138);
        this.drawNum(this.game.player.health.toString(), 116, 138);
    }
};
